...
export function MovementCard({ movement, index }: MovementCardProps) {
  ...
  return (
    <motion.div
      ...
      className="flex items-start space-x-3 p-3 rounded-xl border border-border/50 bg-card hover:shadow-md hover:border-primary/30 transition-all group sm:items-center sm:space-x-4 sm:p-4"
    >
