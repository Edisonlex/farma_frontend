...
export function SystemSettings() {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Configuración de Base de Datos - ELIMINADO ya que estas propiedades no existen en SystemConfig */}

      {/* Configuración de Rendimiento - ELIMINADO ya que estas propiedades no existen en SystemConfig */}

      {/* Configuración de Logs - ELIMINADO ya que estas propiedades no existen en SystemConfig */}

      {/* Configuración de Red - ELIMINADO ya que estas propiedades no existen en SystemConfig */}
